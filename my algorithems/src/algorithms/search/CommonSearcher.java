...
public abstract class CommonSearcher<T> implements Searcher<T> {
	...
	//ctor-that we inint the open and close data structures.
	 ...
	 * @return the double
	 */
	protected double calculateCostBetweenStates(Searchable<T> s, State<T> s1, State<T> s2) {
	 ...
	 */
	//need to get Solution.not arraylist.
	@Override
	public abstract SearchSolution<T> Search(Searchable<T> s);
